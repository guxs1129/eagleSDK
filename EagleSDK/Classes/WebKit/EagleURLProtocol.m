...
static  NSString *const EagleURLProtocolHKey=@"EagleURLProtocolHKey";


@interface EagleURLProtocol()<NSURLSessionDelegate>
@property(nonatomic,strong)NSURLSessionTask *task;

@end

@implementation EagleURLProtocol
...
//    }
    ...
    if ( ([scheme caseInsensitiveCompare:@"http"]==NSOrderedSame || [scheme caseInsensitiveCompare:@"https"]==NSOrderedSame )){
        ...
        if ([NSURLProtocol propertyForKey:EagleURLProtocolHKey inRequest:request]){
            return NO;
        }
        return YES;
    }
...
-(void)startLoading{
    ...
    [NSURLProtocol setProperty:@YES forKey:EagleURLProtocolHKey inRequest:mutableReqeust];
    //TODO：拦截缓存
