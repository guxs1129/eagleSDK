...
@interface EGNavigationBarManager ()
...
@implementation EGNavigationBarManager
...
{
    EGNavigationBarManager *manager = [self sharedManager];
...
+ (EGNavigationBarManager *)sharedManager
{
    static EGNavigationBarManager *manager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[EGNavigationBarManager alloc] init];
        [self initBaseData:manager];
    });
    return manager;
}

+ (void)initBaseData:(EGNavigationBarManager *)manager
{
