...
@class EGRootNavigationController;

@protocol NavigationItemCustomizable <NSObject>
...
IB_DESIGNABLE
@interface UIViewController (EGRootNavigationController) <NavigationItemCustomizable>
 ...
 */
@property (nonatomic, readonly, strong) EGRootNavigationController *rt_navigationController;
