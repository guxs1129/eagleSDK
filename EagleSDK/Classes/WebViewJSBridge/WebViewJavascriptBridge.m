...
{
    _WEAK _WEBVIEW_TYPE* _webView;
    _WEAK id _webViewDelegate;
    long _uniqueId;
...
#endif
    if ([webView isKindOfClass:[_WEBVIEW_TYPE class]]) {
...
- (void)setWebViewDelegate:(_WEBVIEW_DELEGATE_TYPE*)webViewDelegate
{
...
- (void)send:(id)data responseCallback:(ResponseCallback)responseCallback
{
...
- (void) _platformSpecificSetup:(_WEBVIEW_TYPE*)webView
{
    _webView = webView;
...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    __strong _WEBVIEW_DELEGATE_TYPE* strongDelegate = _webViewDelegate;
