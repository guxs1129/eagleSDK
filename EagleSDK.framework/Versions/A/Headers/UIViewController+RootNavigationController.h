...
IB_DESIGNABLE
@interface UIViewController (RootNavigationController) <NavigationItemCustomizable>
 ...
 */
@property (nonatomic, readonly, strong) RootNavigationController *rt_navigationController;
